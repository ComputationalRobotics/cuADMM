...
public:
    ...
    DeviceSparseVector(const int gpu_id, const int size, const int nnz) : gpu_id(gpu_id), size(size), nnz(nnz),
...
public:
    ...
    DeviceSparseMatrixDoubleCSC(const int gpu_id, const int row_size, const int col_size, const int nnz) : gpu_id(gpu_id), row_size(row_size), col_size(col_size), nnz(nnz),
                                                                                                           col_ptrs(nullptr), row_ids(nullptr), vals(nullptr), cusparse_descr(NULL)
    {
...
public:
    ...
    DeviceSparseMatrixDoubleCSR(const int gpu_id, const int row_size, const int col_size, const int nnz) : gpu_id(gpu_id), row_size(row_size), col_size(col_size), nnz(nnz),
                                                                                                           row_ptrs(nullptr), col_ids(nullptr), vals(nullptr), cusparse_descr(NULL)
    {
        this->allocate(gpu_id, row_size, col_size, nnz);
    }
