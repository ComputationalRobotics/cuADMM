...
p = load("/home/jordan/antoine/cuADMM/examples/BQP/cuADMM.mat");

[cuda_At, cuda_b, cuda_C, cuda_blk] = data_sdpt3_to_admmSDPcuda(p.sdp);
disp(cuda_blk);

output_dir = "/home/jordan/antoine/cuADMM/examples/BQP/TXT";
